...
<head>
    ...
    <title>SuperTV - M3U8下载工具</title>
    <meta name="keywords" content="SuperTV m3u8 下载工具">
    <meta name="description" content="SuperTV m3u8 下载工具,无需下载软件,打开网站即可下载,自动检测,一键下载">
    <link rel="stylesheet" href="https://cdnjs.webstatic.cn/ajax/libs/normalize/8.0.1/normalize.css">
    <link rel="stylesheet" href="./static/css/reset.css">
    <link rel="stylesheet" href="https://cdnjs.webstatic.cn/ajax/libs/animate.css/4.1.1/animate.min.css">
                                ...
                                <div class="radio-group radio-group-outline">
                                    <label class="radio-button-wrapper" :class="{'radio-button-wrapper-checked': type === 'TS'}">
                                        <span class="radio-button" :class="{'radio-button-checked': type === 'TS'}">
                                            <input class="radio-button-input" type="radio" v-model="type" value="TS">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="help-content">
                            ...
                            <h1>四、推荐设置及问题</h1>
                            <p>如果遇到下载大小异常，播放异常：推荐保存格式为TS，关闭边下边存，下载完成后手动将ts文件重命名为mp4即可。</p>
                            <p>如果下载后无法拖动进度条：对视频使用ffmpeg -c:v copy -c:a copy，可以修复此问题。出现其他异常时可尝试使用ffmpeg进行修复。</p>
                            <h1>五、鸣谢</h1>
                            <p>本工具基于<a href="https://github.com/caiweiming/get-m3u8" target="_blank">get-m3u8项目</a>构建</p>
                        </div>
                    </div>
                    <div class="modal-footer">
...
<script src="https://cdnjs.webstatic.cn/ajax/libs/vue/3.4.14/vue.global.prod.js"></script>
<script src="./static/js/aes-decrypt.js?ver=1.6"></script>
<script src="https://cdnjs.webstatic.cn/ajax/libs/mux.js/7.1.0/mux-mp4.js"></script>
<script src="./static/js/StreamSaver.js?ver=1.6"></script>
<script src="https://cdnjs.webstatic.cn/ajax/libs/hls.js/1.2.7/hls.min.js"></script>
<script src="https://cdnjs.webstatic.cn/ajax/libs/dplayer/1.27.1/DPlayer.min.js"></script>
<script src="./static/js/main.js?ver=1.6"></script>
</body>
</html>